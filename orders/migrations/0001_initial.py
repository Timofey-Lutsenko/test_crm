...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_of_order', models.CharField(max_length=4)),
                ('order_status', models.CharField(max_length=4)),
                ('creation_date', models.DateTimeField()),
                ('closing_date', models.DateTimeField()),
                ('customer', models.ForeignKey(default='Account deleted', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='customer', to='orders.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Employer',
